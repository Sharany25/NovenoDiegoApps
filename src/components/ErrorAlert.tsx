  ...
  <Modal visible={visible} transparent animationType="fade">
    <View style={styles.overlay}>
      <View style={styles.alertBox}>
        <Ionicons name="close-circle-outline" size={44} color="#ff5252" style={{ alignSelf: 'center' }}/>
...
const styles = StyleSheet.create({
  ...
  okBtn: { backgroundColor: '#ff5252', borderRadius: 10, paddingHorizontal: 36, paddingVertical: 11 },
